...
interface ToolInsightsSectionProps {
  ...
  onNavigateToCameras?: (newCamera?: CameraFeedItem) => void;
}
...
export const ToolInsightsSection: React.FC<ToolInsightsSectionProps> = ({
  ...
  return (
    <div id="operational-overview-and-recently-added" className="space-y-8 pt-2">
            ...
            <GlassPressCard className="p-5 flex flex-col justify-between h-full space-y-4" id="on-demand-verification-card">
              ...
              <div className="flex flex-col items-center justify-center text-center space-y-4 py-2">
                ...
                <button
                  ...
                  className="w-full py-2.5 px-4 rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white font-bold text-xs font-['SF_Pro_Text'] shadow-lg shadow-blue-900/40 transition-all flex items-center justify-center gap-2 cursor-pointer"
                >
      ...
      {/* Footage On-Demand Verification Modal */}
      <FootageUploadModal
        isOpen={isUploadModalOpen}
        onClose={() => setIsUploadModalOpen(false)}
        fileName={uploadedFileName}
        fileObj={uploadedFileObj}
        onRunPrediction={handlePredictionModalComplete}
      />
    </div>
  );
};
